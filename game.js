...
(function (window, undefined) {
    ...
    function init() {
        ...
        iFood2.src = 'assets/extrafruit.png';
    ...
    gameScene.act = function () {
        ...
        if (!pause) {
            ...
            if (body[0].intersects(food2)) {
                ...
                function sendscore(url, callback) {
                    let solicitud = new XMLHttpRequest();
                    solicitud.open('GET', url, true);
                    solicitud.onreadystatechange = (event) => {
                ...
                sendscore('https://jsonplaceholder.typicode.com/?score=10', callback);
            }
